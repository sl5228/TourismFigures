...
% Horizontal dashed line for 2019 total visitation level (drawn on top)
\draw[dashed, thick, color=black, on layer=axis foreground] (axis cs:2018.5,66.6) -- (axis cs:2029.5,66.6);
\node[anchor=south, on layer=axis foreground] at (axis cs:2024,67.1) {2019 Total Visitation Level (66.6M)};
